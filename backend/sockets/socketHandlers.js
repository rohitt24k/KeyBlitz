...
function initializeSocket(server) {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("createRoom", (roomName) => {
      ...
      const user = onlineUsers.find((d) => d.socketId === socket.id);
